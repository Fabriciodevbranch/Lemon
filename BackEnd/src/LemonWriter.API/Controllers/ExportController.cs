...
public class ExportController : ControllerBase
{
    ...
    public ExportController(IMediator mediator, ICurrentUserService currentUser, IResourceAuthorizationService authorization)
    ...
    {
        if (_currentUser.UserId is not Guid userId || !await _authorization.OwnsBookAsync(userId, bookId, cancellationToken)) return NotFound();
